...
public:
  MutableTransformPublisher(
    rclcpp::Node::SharedPtr node, const std::string & yaml_path,
    const double & period, const bool & commit = true);
...
private:
  ...
  rclcpp::Service<mutable_transform_publisher_msgs::srv::SetTransform>::SharedPtr
